...
USER_AFTER_CHANGE_PASSWORD_ENDPOINT = 'main.home_page'
USER_AFTER_CHANGE_USERNAME_ENDPOINT = 'main.home_page'
USER_AFTER_CONFIRM_ENDPOINT = 'main.home_page'
USER_AFTER_EDIT_USER_PROFILE_ENDPOINT = 'main.home_page'
...
USER_AFTER_REGISTER_ENDPOINT = 'main.home_page'
USER_AFTER_RESEND_EMAIL_CONFIRMATION_ENDPOINT = 'main.home_page'
USER_AFTER_RESET_PASSWORD_ENDPOINT = 'main.home_page'
USER_AFTER_INVITE_ENDPOINT = 'main.home_page'
